...
public class clsDataConnection
{
    ...
    private string GetConString(string SomePath)
    {
        ...
        //connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\product_project\\App_Data\\shopping.mdf; Integrated Security=True;Connect Timeout=30";
